...
export type DxIntlRecordWithScoresQuery = (
  ...
  & { dx_intl_players: Array<(
    { __typename?: 'dx_intl_players' }
    & Pick<Dx_Intl_Players, 'updated_at'>
    & { dx_intl_record?: Maybe<(
      { __typename?: 'dx_intl_records' }
